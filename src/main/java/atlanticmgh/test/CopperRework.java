...
public class CopperRework implements ModInitializer {
	...
	public void onInitialize() {
        ...
        //Zurücksetzen der Effekte nach Tod
        ...
        ServerLivingEntityEvents.ALLOW_DAMAGE.register((entity, source, amount) -> {
            if(entity instanceof PlayerEntity player) {
                ...
                if (player.hasStatusEffect(ModEffects.ARMOR_PHYSICAL_DEBUFF)) {
                ...
                if (source.getAttacker() instanceof LivingEntity living) {
                    ...
                    if (player.hasStatusEffect(ModEffects.ARMOR_UNDEAD_MOB_DEBUFF)) {
                        if (attacker instanceof ZombieEntity || attacker instanceof SkeletonEntity) {
                            return ActionResult.FAIL.isAccepted();
                        }
                    }
                    if (player.hasStatusEffect(ModEffects.ARMOR_NETHER_MOB_DEBUFF)) {
                    ...
                    if (player.hasStatusEffect(ModEffects.ARMOR_PIGLIN_MOB_DEBUFF)) {
